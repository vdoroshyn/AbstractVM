...
void Lexer::printOutUsage() {
	std::cout << "\033[1;95mcomments\033[0m: \033[0;34mComments start with a '\033[1;94m;\033[0;34m' symbol and end with a newline. A comment can be either at the start of a line or after an instruction.\033[0m" << std::endl; 
	std::cout << "\033[1;95mpush v\033[0m: \033[0;34mPushes the value \033[1;94mv\033[0m \033[0;34mat the top of the stack, which must have one of the following forms:\033[0m" << std::endl;
	...
	std::cout << "\033[1;95mpop\033[0m: \033[0;34mUnstacks the value from the top of the stack. \033[1;91mIf the stack is empty, the program execution stops with an error.\033[0m" << std::endl << std::endl;
	...
	std::cout << "\033[1;95massert v\033[0m: \033[0;34mAsserts that the value at the top of the stack is equal to the one passed as parameter for this instruction. \033[1;91mIf it is not - the program execution stops with an error.\033[0m \033[0;34mThe value \033[1;94mv\033[0m \033[0;34mhas the same form that those passed as parameters to the command push.\033[0m" << std::endl<< std::endl;
	std::cout << "\033[1;95madd\033[0m: \033[0;34mUnstacks the first two values in the stack, adds them together, and pushes the result on the stack. \033[1;91mIf there are less than 2 operands in the stack, the program execution stops with an error.\033[0m" << std::endl << std::endl;
	std::cout << "\033[1;95msub\033[0m: \033[0;34mUnstacks the first two values in the stack, subtracts them, and pushes the result on the stack. \033[1;91mIf there are less than 2 operands in the stack, the program execution stops with an error.\033[0m" << std::endl << std::endl;
	std::cout << "\033[1;95mmul\033[0m: \033[0;34mUnstacks the first two values in the stack, multiplies them, and pushes the result on the stack. \033[1;91mIf there are less than 2 operands in the stack, the program execution stops with an error.\033[0m" << std::endl << std::endl;
	std::cout << "\033[1;95mdiv\033[0m: \033[0;34mUnstacks the first two values in the stack, divides them, and pushes the result on the stack. \033[1;91mIf there are less than 2 operands in the stack or the divisor is equal to 0, the program execution stops with an error.\033[0m" << std::endl << std::endl;
	std::cout << "\033[1;95mmod\033[0m: \033[0;34mUnstacks the first two values in the stack, calculates the modulus, and pushes the result on the stack. \033[1;91mIf there are less than 2 operands in the stack or the divisor is equal to 0, the program execution stops with an error.\033[0m" << std::endl << std::endl;
	std::cout << "\033[1;95mprint\033[0m: \033[0;34mAsserts that the value at the top of the stack is a 8-bit integer (\033[1;91mif not, check the instructions for assert\033[0m\033[0;34m); then interprets it as an ASCII value and displays the corresponding character on the standard output.\033[0m" << std::endl << std::endl;
	std::cout << "\033[1;95mexit\033[0m: \033[0;34mTerminates the execution of the current program. \033[1;91mThere must be only one exit command and it must be located at the end of the input.\033[0m" << std::endl;
}
